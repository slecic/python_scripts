#################################
#Author: Sonja Lecic
#necessary argument: --infile INFILE: file name with chromosome, coordinate and CG % methylation value
#necessary argument: --outfile OUTFILE: output file suffix
#Optional arguments:
...
#input file, formatted as having 3 columns: chromosome, position, and methyl value
...
#For each lag, this for loop identifies pairs of loci in the genome with that lag, and saves their methyl values in a list. Then it computes the correlations between the 2 lists.
